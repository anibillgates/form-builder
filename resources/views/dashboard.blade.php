                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <a href="{{ route('forms.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block">
                                Browse Forms
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <a href="{{ route('submissions.my') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block">
                                View Submissions
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-center p-4 bg-gray-50 rounded-lg">
                                <p class="text-3xl font-bold text-blue-600">{{ \App\Models\Form::where('is_active', true)->count() }}</p>
                                <p class="text-sm text-gray-600 mt-1">Available Forms</p>
                            </div>
                            <div class="text-center p-4 bg-gray-50 rounded-lg">
                                <p class="text-3xl font-bold text-green-600">{{ auth()->user()->submissions()->count() }}</p>
