            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold mb-2"><?php echo e($form->form_name); ?></h3>
...
<?php endif; ?>
<?php /**PATH E:\PDMR Softwares\Projects\dynamic-form-builder\resources\views/admin/forms/index.blade.php ENDPATH**/ ?>